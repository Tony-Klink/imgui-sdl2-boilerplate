...
// Create a surface from an image file, containing both the surface and the destructor
    inline surf_ptr_t make_surface(SDL_RWops* sdlfile)
    {
        return make_resource(IMG_Load_RW, SDL_FreeSurface, sdlfile, 1);
    }
